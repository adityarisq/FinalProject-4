...
public class BusDetail extends AppCompatActivity {
    TextView nama_bus, kotaAsal, kotaSampai, jamAsal, jamSampai, durasi, nopol, harga1, harga2;
    Button btn_bookNow;
    ImageView btn_back;
...
//            startActivity(intent);
        ...
        db3.collection("schedule")
                .whereEqualTo("bus",namaBus)//namaBus "Sempati Star"
                .get()
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        ...
                        if (task.isSuccessful()){
                            ...
                            for (QueryDocumentSnapshot document : task.getResult()){
                                ...
                                harga2.setText(document.get("harga").toString());
                            }
